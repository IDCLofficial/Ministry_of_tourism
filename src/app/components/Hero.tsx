...
export const SubsequentHero = ({ children, className }: SubsequentHeroProps) => {
    return (
        <div className="relative h-[350px] md:min-h-[80vh] px-2 md:px-[3rem] py-8 md:py-10 flex flex-col gap-2 justify-center bg-gradient-to-r from-green-900/20 via-black to-black">
