            ...
            <div className="relative z-10 py-10">
                <div className="w-full md:w-[70%] flex flex-col gap-8">
                    <PageTransition type="fadeUp">
                        <Title label={title}/>
                        <h1 className="lg:text-5xl font-bold text-white leading-tight py-4">{caption}</h1>
...
export const SubsequentHero = ({ children, className }: SubsequentHeroProps) => {
    return (
        <div className="relative h-[350px] md:min-h-[85vh] px-2 lg:px-[3rem] py-8 md:py-10 flex flex-col gap-2 justify-center bg-gradient-to-r from-green-900/20 via-black to-black">
